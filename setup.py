...
setup(
    ...
    [console_scripts]
    paildocket-initdb = paildocket.management:initialize_database
    paildocket-adduser = paildocket.management:add_user
    paildocket-fixture = paildocket.management:manage_fixtures
    """,
)
